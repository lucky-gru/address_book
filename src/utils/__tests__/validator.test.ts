...
describe('Test addressFormValidate function', () => {
  it('Should return false if required field is undefined or empty string', () => {
    const addr1: Address = {
      line1: '',
      line2: '',
      line3: '',
  ...
  it('Should return true if required field is not undefined or empty', () => {
    const addr1: Address = {
